...
export function ControlPanel(props) {
  ...
  return (
    <div className={props.horizontal ? "control-panel horizontal-control-panel flex-column" : "control-panel flex-column"} style={{ alignItems: "flex-end" }}>
      <div className="panel flex-column" style={{ justifyContent: "center" }}>
        ...
        {!props.toggle ?
          ...
          :
          <div style={{ position: "absolute", zIndex: 3, display: "flex", justifyContent: "center", alignItems: "center"}}>
            <div>
              <p className="data-indicator flex-column">{props.papers ? props.papers : ""}</p>
              <small className="description">Visited</small>
            </div>
          </div>
        }
      </div>
